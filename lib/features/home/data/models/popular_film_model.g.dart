...
part of 'popular_film_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class PopularFilmModelAdapter extends TypeAdapter<PopularFilmModel> {
  @override
  final int typeId = 0;

  @override
  PopularFilmModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, PopularFilmModel obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.adult)
  ...
  bool operator ==(Object other) =>
      ...
      other is PopularFilmModelAdapter &&
